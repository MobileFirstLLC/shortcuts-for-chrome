/**
 * List of all links featured in the menu. The items in this list should be
 * formatted so that `'chrome://' + item` is a navigable url.
 *
 * @namespace MenuLinks
 * @type Array.<string>
 */
